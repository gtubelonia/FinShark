...
namespace FinShark.Migrations
{
    ...
    [Migration("20240903173444_UserProfile")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FinShark.Models.StockPortfolio", b =>
                {
                    b.Property<string>("AppUserId")
                        .HasColumnType("nvarchar(450)");
                    ...
                    b.ToTable("StockPortfolio");
                });

            modelBuilder.Entity("FinShark.Models.UserProfile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "2d566264-b8c8-4f34-9c05-d41f6b3de618",
                            Name = "Admin",
                            NormalizedName = "ADMIN"
                        },
                        new
                        {
                            Id = "178e1fb1-13a4-4291-898a-6e9e7bf98118",
                            Name = "User",
                            NormalizedName = "USER"
                        });
                });
            ...
            modelBuilder.Entity("FinShark.Models.UserProfile", b =>
                {
                    b.HasOne("FinShark.Models.AppUser", "AppUser")
                        .WithOne("userProfile")
                        .HasForeignKey("FinShark.Models.UserProfile", "AppUserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
